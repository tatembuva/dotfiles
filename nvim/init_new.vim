...
"Key Mappings
source ~/dotfiles/nvim/general/mappings.vim
"Themes
source ~/dotfiles/nvim/themes/solarized8.vim
" source ~/dotfiles/nvim/themes/gruvbox.vim

"Plugin Config
source ~/dotfiles/nvim/plugin-config/nerdtree.vim
source ~/dotfiles/nvim/plugin-config/airline.vim
source ~/dotfiles/nvim/plugin-config/fzf.vim
source ~/dotfiles/nvim/plugin-config/ack.vim
